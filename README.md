# Project
Productivity of Turkish Theatre in the 2023/2024 Season: Number of shows and performances, audience rate, change over time
Dataset: https://data.tuik.gov.tr/Bulten/Index?p=Sinema-ve-Gosteri-Sanatlari-Istatistikleri-2024-53955
Plots:
```{r}
...
library(scales)
```
Bar plot Comparison of Original and Translated Shows
```{r}
...
```
<img width="3600" height="1800" alt="bar_ot (4)" src="https://github.com/user-attachments/assets/3ca963d7-f983-4b37-8acc-acc04d2a6c52" />
Bar plot Comparison of Adult and Children Shows"
```{r}
ggplot(data, aes(fill = age_group, x = reorder(type, +t_show), y = t_show)) +
  ...
  legend.text = element_text(size = 16, face="bold"),
    legend.title = element_blank(),
        legend.position = "bottom")
```
<img width="3600" height="1800" alt="bar_ac (2)" src="https://github.com/user-attachments/assets/b9a75a7c-2f89-48d0-877c-cd4798137548" />
...
```
<img width="3600" height="1800" alt="time series" src="https://github.com/user-attachments/assets/12f8ed9e-7180-467e-a98e-161d53dfe345" />

Correlation Between Theater Attendance-Hall Occupancy Rate By Province
```{r}
etiket<-data%>%
...
```
<img width="5400" height="3000" alt="scatter plot" src="https://github.com/user-attachments/assets/105f063d-2be9-4393-b624-5aaaf8a9e1c5" />

Number of Children’s Theatre Performances by Province
```{r}
top_15 <- data %>% 
...
```
<img width="4800" height="4200" alt="dot plot" src="https://github.com/user-attachments/assets/614c2354-52c9-479f-b11d-0586f242ff73" />

Audience Rate By Province
```{r}
data("tr_nuts3")
```
```{r}
...
```
<img width="3000" height="2100" alt="harita (3)" src="https://github.com/user-attachments/assets/94ec61e0-58f6-4d23-ade4-4724e3865d9c" />
